...
struct PageViewControllerV2<Page: View>: UIViewControllerRepresentable {
    var pages: [Page]
    ...
    // SwiftUI 在准备显示视图时只调用此方法一次，然后管理视图控制器的生命周期
...
//            [UIHostingController(rootView: pages[0])], direction: .forward, animated: true
    ...
    class Coordinator: NSObject, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
        var parent: PageViewControllerV2
        var controllers = [UIViewController]()

        init(_ pageViewController: PageViewControllerV2) {
